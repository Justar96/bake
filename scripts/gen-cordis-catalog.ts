...
export const EVENT_WALK_EXEMPTIONS: Record<string, string> = {
  'connection/reset': 'client-face transport signal — packages/api/gateway/README.md owns the API',
}
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  CommandArgumentChoice: 'commands.md',
  CommandChoiceProvider: 'commands.md',
