...
Bake 使用 `packages/` 下的共享包来实现会话、agent 执行、工具、持久化及配套服务。可从本页找到包组及其当前成员。
...
| [`api/`](api/README.zh.md) | Typert Gateway 与设置控制器 |
...
| [`deliverables/`](deliverables/README.zh.md) | 显式文件交付工具 |
