...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: '@Remote async choices(agent: Agent, name: string, partialInput: string, signal: AbortSignal): Promise<readonly CommandArgumentChoice[]>',
        description: 'Resolve advisory argument choices from the effective scoped command. A caller owns cancellation and awaits provider settlement.',
        parameters: [{ name: 'agent', description: 'exact receiving agent and scoped-layer key.' }, { name: 'name', description: 'command name without the leading slash.' }, { name: 'partialInput', description: 'argument text typed so far.' }, { name: 'signal', description: 'cancels a dynamic provider.' }],
        returns: 'the validated choices, or an empty list when the command advertises none.',
      },
      {
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  },
  {
    ...
    declaration: 'export type CommandChoiceProvider = (agent: Agent, partialInput: string, signal: AbortSignal) => readonly CommandArgumentChoice[] | Promise<readonly CommandArgumentChoice[]>;',
  },
  {
